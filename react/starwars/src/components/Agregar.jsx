    ...
    return(
        ...
        <>
            ...
            <div className="inputs">
                <input type="text" name="episodio" placeholder='Numero del episodio' onChange={handleChange}/>
                <input type="text" name="personaje" placeholder='Nombre del personaje' onChange={handleChange}/>
            </div>
